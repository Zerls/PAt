...
static bool cmp1(person a, person b) {
    return a.arrive < b.arrive;
}
static bool cmp2(person a, person b) {
    return a.start < b.start;
}
static vector<person> player;
static vector<tablenode> table;
static void alloctable(int personid, int tableid) {
...
static int findnextvip(int vipid) {
    vipid++;
